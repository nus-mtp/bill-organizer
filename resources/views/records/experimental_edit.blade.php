            ...
            <div class="ten wide column">
                <div class="bill-image">
                    ...
                    <div id="bill-wrapper">
                        ...
                        <img src="{{route('show_temp_record_page', $first_page)}}" id="bill" onmousedown="getCoordinates(event)" onmouseup="getCoordsAgain(event)" onmouseout="coordsFailSafe(event)" onmousemove="getChangingCoords(event)">
                    </div>
                </div>
                <center>
